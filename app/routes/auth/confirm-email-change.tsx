  ...
  if (isLinkInvalid) {
    content = (
      <div>
        ...
        <h1 className="text-xl font-bold text-gray-900 mb-2">Nieprawidłowy link weryfikacyjny</h1>
    ...
    content = (
      <div>
        ...
        <p className="text-sm text-gray-600 mb-6">
          Twój nowy adres e-mail został pomyślnie potwierdzony. Możesz teraz zalogować się do
          systemu przy użyciu nowego adresu.
        </p>
        <Button
          onClick={() => navigate('/')}
    ...
    content = (
      <div>
        ...
        <p className="text-sm text-gray-600 mb-6">
          Kliknij poniższy przycisk, aby zatwierdzić nowy adres e-mail przypisany do Twojego konta.
        </p>
