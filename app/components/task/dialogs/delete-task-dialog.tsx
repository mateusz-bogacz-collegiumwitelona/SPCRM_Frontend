...
export const DeleteTaskDialog: React.FC<DeleteTaskDialogProps> = ({
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const fallback = responseData?.message || apiError.message || 'Nie udało się usunąć zadania.';
      ...
      <DialogContent className="sm:max-w-112.5 bg-white">
        ...
        <div className="py-4 space-y-3">
          ...
          <p className="text-sm text-gray-600 text-center leading-relaxed">
            Czy na pewno chcesz bezpowrotnie usunąć zadanie{' '}
            {taskTitle ? <strong>„{taskTitle}”</strong> : 'to zadanie'}? <br />
