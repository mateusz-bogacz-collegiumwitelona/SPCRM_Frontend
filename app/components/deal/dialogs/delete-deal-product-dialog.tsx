...
interface DeleteDealProductDialogProps {
...
export const DeleteDealProductDialog: React.FC<DeleteDealProductDialogProps> = ({
  isOpen,
  onClose,
  onConfirm,
  isLoading,
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const fallback =
        responseData?.message || apiError.message || 'Nie udało się usunąć produktu z transakcji.';
      ...
      <DialogContent className="sm:max-w-112.5 bg-white">
        ...
        <div className="py-4 space-y-3">
          ...
          <p className="text-sm text-gray-600 text-center leading-relaxed">
            ...
            {productName ? <strong>„{productName}”</strong> : 'ten produkt'} z transakcji? <br />
            Wartość zamówienia zostanie automatycznie pomniejszona.
          </p>
        </div>
