...
export const DeleteDealDialog: React.FC<DeleteDealDialogProps> = ({
  isOpen,
  onClose,
  onConfirm,
  isLoading,
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const fallback =
        responseData?.message || apiError.message || 'Nie udało się usunąć transakcji.';
      ...
      <DialogContent className="sm:max-w-112.5 bg-white">
        ...
        <div className="py-4 space-y-3">
          ...
          <p className="text-sm text-gray-600 text-center leading-relaxed">
            ...
            {dealTitle ? <strong>„{dealTitle}”</strong> : 'tę transakcję'}? <br />
            Status transakcji zostanie zmieniony na{' '}
            <span className="font-semibold text-red-600">Anulowana</span>.
          </p>
        </div>
